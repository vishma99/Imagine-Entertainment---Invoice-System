  ...
  const handleStatusChange = async (id, fieldName, newStatus) => {
    ...
    try {
      ...
      const response = await axios.put(
        `https://imagine-entertainment-invoice-system.onrender.com/api/quotations/${id}`,
        {
          [fieldName]: newStatus,
          ...extraData,
        },
  ...
  const stats = {
    ...
    proforma: allInvoices.filter(
      (inv) =>
        ...
        inv.invoiceType === "Requesting Balance Payment Invoice",
    ).length,
    ...
    <div className="dashboard-container" style={{ padding: "20px" }}>
      ...
      >
        <div
          ...
          onClick={() => navigate("/taxInvoice")}
        >
          <h3>Tax Invoices</h3>
          <p className="value">{stats.tax.toString().padStart(2, "0")}</p>
        </div>
        ...
        <div
          ...
          style={{ cursor: "pointer" }}
          onClick={() => navigate("/commercialInvoice")}
        >
        ...
        <div
          ...
          style={{ cursor: "pointer" }}
          onClick={() => navigate("/normalInvoices")}
        >
          <h3>Normal Invoices</h3>
          <p className="value">{stats.normal.toString().padStart(2, "0")}</p>
        </div>
      </div>
