...
export default function NormalInvoices() {
  ...
  return (
    <div className="dashboard-container" style={{ padding: "20px" }}>
      <h2>Generated Normal Invoices</h2>
      ...
      <div className="table-scroll-container">
        ...
        >
          ...
          <tbody>
            {/* 🟢 මෙතනදී .filter() එක භාවිතා කරලා Normal Invoice විතරක් තෝරාගන්නවා */}
            {allInvoices.filter((inv) => inv.invoiceType === "Normal Invoice")
              .length > 0 ? (
              allInvoices
                .filter((inv) => inv.invoiceType === "Normal Invoice") // පෙරා ගැනීම
                .map((inv, index) => (
                  <tr key={index}>
                    <td>{inv.date}</td>
                    <td>{inv.invoiceNo}</td>
